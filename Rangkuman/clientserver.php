...
<body>
    ...
    <div class="md:flex mt-5 ">
        ...
        <p class="text-sm md:w-1/2 text-left font-['Montserrat', sans-serif;] ml-4 mr-4 text-white">Source code ini dibuat dengan html yang disisipkan script php di dalamnya. Untuk menyisipkan syntax php dimulai dengan memasukkan syntax 
             ...
             isi variabel yang akan kita jalankan dan memasukkan atribut yaitu  echo $hello, $world;. Langkah yang terakhir yaitu, kita menutup lagi dengan 
             syntax ?>, karena kita menggabungkan php di file html. Tetapi, jika kita hanya menggunakan php saja dan tidak digabungkan di html, maka tidak 
