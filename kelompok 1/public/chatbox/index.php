    ...
    ?>
        <div id="wrapper">
            ...
            <form name="message" action="">
                <input name="usermsg" type="text" id="usermsg" class="input bg-orange text-white input-bordered input-primary w-full max-w-xs" />
                <input class="btn btn-active ml-3 bg-orange-600" name="submitmsg" type="submit" id="submitmsg" value="Send" />
            </form>
        </div>
